...
ActiveRecord::Schema.define(version: 20151128163311) do
  ...
  add_index "users", ["lti_identifier"], name: "index_users_on_lti_identifier", using: :btree
