...
export const list_quizzes_in_course = { type: "LIST_QUIZZES_IN_COURSE", method: "get"};
...
export const get_single_quiz = { type: "GET_SINGLE_QUIZ", method: "get"};
...
export const create_quiz = { type: "CREATE_QUIZ", method: "post"};
...
export const edit_quiz = { type: "EDIT_QUIZ", method: "put"};
...
export const delete_quiz = { type: "DELETE_QUIZ", method: "delete"};
...
export const reorder_quiz_items = { type: "REORDER_QUIZ_ITEMS", method: "post"};
...
export const validate_quiz_access_code = { type: "VALIDATE_QUIZ_ACCESS_CODE", method: "post"};