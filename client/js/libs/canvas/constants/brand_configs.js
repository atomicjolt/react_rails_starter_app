...
export const get_brand_config_variables_that_should_be_used_for_this_domain = { type: "GET_BRAND_CONFIG_VARIABLES_THAT_SHOULD_BE_USED_FOR_THIS_DOMAIN", method: "get", reducer: 'brand_configs'};