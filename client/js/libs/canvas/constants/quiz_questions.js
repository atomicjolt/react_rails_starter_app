...
export const list_questions_in_quiz_or_submission = { type: "LIST_QUESTIONS_IN_QUIZ_OR_SUBMISSION", method: "get"};
...
export const get_single_quiz_question = { type: "GET_SINGLE_QUIZ_QUESTION", method: "get"};
...
export const create_single_quiz_question = { type: "CREATE_SINGLE_QUIZ_QUESTION", method: "post"};
...
export const update_existing_quiz_question = { type: "UPDATE_EXISTING_QUIZ_QUESTION", method: "put"};
...
export const delete_quiz_question = { type: "DELETE_QUIZ_QUESTION", method: "delete"};