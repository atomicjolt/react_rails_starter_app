...
export const retrieve_all_quiz_reports = { type: "RETRIEVE_ALL_QUIZ_REPORTS", method: "get", key: "retrieve_all_quiz_reportsretrieve_all_quiz_reports_{course_id}_{quiz_id}", required: ["course_id","quiz_id"] };
...
export const create_quiz_report = { type: "CREATE_QUIZ_REPORT", method: "post", key: "create_quiz_reportcreate_quiz_report_{course_id}_{quiz_id}", required: ["course_id","quiz_id"] };
...
export const get_quiz_report = { type: "GET_QUIZ_REPORT", method: "get", key: "get_quiz_reportget_quiz_report_{course_id}_{quiz_id}_{id}", required: ["course_id","quiz_id","id"] };
