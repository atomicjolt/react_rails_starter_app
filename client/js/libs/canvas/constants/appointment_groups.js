...
export const list_appointment_groups = { type: "LIST_APPOINTMENT_GROUPS", method: "get"};
...
export const create_appointment_group = { type: "CREATE_APPOINTMENT_GROUP", method: "post"};
...
export const get_single_appointment_group = { type: "GET_SINGLE_APPOINTMENT_GROUP", method: "get"};
...
export const update_appointment_group = { type: "UPDATE_APPOINTMENT_GROUP", method: "put"};
...
export const delete_appointment_group = { type: "DELETE_APPOINTMENT_GROUP", method: "delete"};
...
export const list_user_participants = { type: "LIST_USER_PARTICIPANTS", method: "get"};
...
export const list_student_group_participants = { type: "LIST_STUDENT_GROUP_PARTICIPANTS", method: "get"};