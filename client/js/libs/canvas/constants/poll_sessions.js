...
export const list_poll_sessions_for_poll = { type: "LIST_POLL_SESSIONS_FOR_POLL", method: "get"};
...
export const get_results_for_single_poll_session = { type: "GET_RESULTS_FOR_SINGLE_POLL_SESSION", method: "get"};
...
export const create_single_poll_session = { type: "CREATE_SINGLE_POLL_SESSION", method: "post"};
...
export const update_single_poll_session = { type: "UPDATE_SINGLE_POLL_SESSION", method: "put"};
...
export const delete_poll_session = { type: "DELETE_POLL_SESSION", method: "delete"};
...
export const open_poll_session = { type: "OPEN_POLL_SESSION", method: "get"};
...
export const close_opened_poll_session = { type: "CLOSE_OPENED_POLL_SESSION", method: "get"};
...
export const list_opened_poll_sessions = { type: "LIST_OPENED_POLL_SESSIONS", method: "get"};
...
export const list_closed_poll_sessions = { type: "LIST_CLOSED_POLL_SESSIONS", method: "get"};