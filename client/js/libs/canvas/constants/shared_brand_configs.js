...
export const share_brandconfig_theme = { type: "SHARE_BRANDCONFIG_THEME", method: "post"};
...
export const update_shared_theme = { type: "UPDATE_SHARED_THEME", method: "put"};
...
export const un_share_brandconfig_theme = { type: "UN_SHARE_BRANDCONFIG_THEME", method: "delete"};