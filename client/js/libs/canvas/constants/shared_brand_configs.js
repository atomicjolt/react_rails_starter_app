...
export const share_brandconfig_theme = { type: "SHARE_BRANDCONFIG_THEME", method: "post", reducer: 'shared_brand_configs'};
...
export const update_shared_theme = { type: "UPDATE_SHARED_THEME", method: "put", reducer: 'shared_brand_configs'};
...
export const un_share_brandconfig_theme = { type: "UN_SHARE_BRANDCONFIG_THEME", method: "delete", reducer: 'shared_brand_configs'};