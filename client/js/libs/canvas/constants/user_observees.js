...
export const list_observees = { type: "LIST_OBSERVEES", method: "get"};
...
export const add_observee_with_credentials = { type: "ADD_OBSERVEE_WITH_CREDENTIALS", method: "post"};
...
export const show_observee = { type: "SHOW_OBSERVEE", method: "get"};
...
export const add_observee = { type: "ADD_OBSERVEE", method: "put"};
...
export const remove_observee = { type: "REMOVE_OBSERVEE", method: "delete"};