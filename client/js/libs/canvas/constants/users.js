...
export const list_users_in_account = { type: "LIST_USERS_IN_ACCOUNT", method: "get"};
...
export const list_activity_stream_self = { type: "LIST_ACTIVITY_STREAM_SELF", method: "get"};
...
export const list_activity_stream_activity_stream = { type: "LIST_ACTIVITY_STREAM_ACTIVITY_STREAM", method: "get"};
...
export const activity_stream_summary = { type: "ACTIVITY_STREAM_SUMMARY", method: "get"};
...
export const list_todo_items = { type: "LIST_TODO_ITEMS", method: "get"};
...
export const list_upcoming_assignments_calendar_events = { type: "LIST_UPCOMING_ASSIGNMENTS_CALENDAR_EVENTS", method: "get"};
...
export const list_missing_submissions = { type: "LIST_MISSING_SUBMISSIONS", method: "get"};
...
export const hide_stream_item = { type: "HIDE_STREAM_ITEM", method: "delete"};
...
export const hide_all_stream_items = { type: "HIDE_ALL_STREAM_ITEMS", method: "delete"};
...
export const users_upload_file = { type: "USERS_UPLOAD_FILE", method: "post"};
...
export const show_user_details = { type: "SHOW_USER_DETAILS", method: "get"};
...
export const create_user = { type: "CREATE_USER", method: "post"};
...
export const self_register_user = { type: "SELF_REGISTER_USER", method: "post"};
...
export const update_user_settings = { type: "UPDATE_USER_SETTINGS", method: "get"};
...
export const get_custom_colors = { type: "GET_CUSTOM_COLORS", method: "get"};
...
export const get_custom_color = { type: "GET_CUSTOM_COLOR", method: "get"};
...
export const update_custom_color = { type: "UPDATE_CUSTOM_COLOR", method: "put"};
...
export const edit_user = { type: "EDIT_USER", method: "put"};
...
export const merge_user_into_another_user_destination_user_id = { type: "MERGE_USER_INTO_ANOTHER_USER_DESTINATION_USER_ID", method: "put"};
...
export const merge_user_into_another_user_accounts = { type: "MERGE_USER_INTO_ANOTHER_USER_ACCOUNTS", method: "put"};
...
export const split_merged_users_into_separate_users = { type: "SPLIT_MERGED_USERS_INTO_SEPARATE_USERS", method: "post"};
...
export const get_user_profile = { type: "GET_USER_PROFILE", method: "get"};
...
export const list_avatar_options = { type: "LIST_AVATAR_OPTIONS", method: "get"};
...
export const list_user_page_views = { type: "LIST_USER_PAGE_VIEWS", method: "get"};
...
export const store_custom_data = { type: "STORE_CUSTOM_DATA", method: "put"};
...
export const load_custom_data = { type: "LOAD_CUSTOM_DATA", method: "get"};
...
export const delete_custom_data = { type: "DELETE_CUSTOM_DATA", method: "delete"};
...
export const list_course_nicknames = { type: "LIST_COURSE_NICKNAMES", method: "get"};
...
export const get_course_nickname = { type: "GET_COURSE_NICKNAME", method: "get"};
...
export const set_course_nickname = { type: "SET_COURSE_NICKNAME", method: "put"};
...
export const remove_course_nickname = { type: "REMOVE_COURSE_NICKNAME", method: "delete"};
...
export const clear_course_nicknames = { type: "CLEAR_COURSE_NICKNAMES", method: "delete"};