...
export const index_of_active_global_notification_for_user = { type: "INDEX_OF_ACTIVE_GLOBAL_NOTIFICATION_FOR_USER", method: "get", key: "index_of_active_global_notification_for_userindex_of_active_global_notification_for_user_{account_id}_{user_id}", required: ["account_id","user_id"] };
...
export const show_global_notification = { type: "SHOW_GLOBAL_NOTIFICATION", method: "get", key: "show_global_notificationshow_global_notification_{account_id}_{user_id}_{id}", required: ["account_id","user_id","id"] };
...
export const close_notification_for_user = { type: "CLOSE_NOTIFICATION_FOR_USER", method: "delete", key: "close_notification_for_userclose_notification_for_user_{account_id}_{user_id}_{id}", required: ["account_id","user_id","id"] };
...
export const create_global_notification = { type: "CREATE_GLOBAL_NOTIFICATION", method: "post", key: "create_global_notificationcreate_global_notification_account_id", required: ["account_id"] };
...
export const update_global_notification = { type: "UPDATE_GLOBAL_NOTIFICATION", method: "put", key: "update_global_notificationupdate_global_notification_{account_id}_{id}", required: ["account_id","id"] };