...
export const create_new_grading_standard_accounts = { type: "CREATE_NEW_GRADING_STANDARD_ACCOUNTS", method: "post"};
...
export const create_new_grading_standard_courses = { type: "CREATE_NEW_GRADING_STANDARD_COURSES", method: "post"};
...
export const list_grading_standards_available_in_context_courses = { type: "LIST_GRADING_STANDARDS_AVAILABLE_IN_CONTEXT_COURSES", method: "get"};
...
export const list_grading_standards_available_in_context_accounts = { type: "LIST_GRADING_STANDARDS_AVAILABLE_IN_CONTEXT_ACCOUNTS", method: "get"};