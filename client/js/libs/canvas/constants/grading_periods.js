...
export const list_grading_periods_accounts = { type: "LIST_GRADING_PERIODS_ACCOUNTS", method: "get"};
...
export const list_grading_periods_courses = { type: "LIST_GRADING_PERIODS_COURSES", method: "get"};
...
export const get_single_grading_period = { type: "GET_SINGLE_GRADING_PERIOD", method: "get"};
...
export const update_single_grading_period = { type: "UPDATE_SINGLE_GRADING_PERIOD", method: "put"};
...
export const delete_grading_period_courses = { type: "DELETE_GRADING_PERIOD_COURSES", method: "delete"};
...
export const delete_grading_period_accounts = { type: "DELETE_GRADING_PERIOD_ACCOUNTS", method: "delete"};