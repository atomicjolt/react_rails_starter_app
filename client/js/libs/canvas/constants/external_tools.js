...
export const list_external_tools_courses = { type: "LIST_EXTERNAL_TOOLS_COURSES", method: "get", key: 'list_external_tools_courses'};
...
export const list_external_tools_accounts = { type: "LIST_EXTERNAL_TOOLS_ACCOUNTS", method: "get", key: 'list_external_tools_accounts'};
...
export const list_external_tools_groups = { type: "LIST_EXTERNAL_TOOLS_GROUPS", method: "get", key: 'list_external_tools_groups'};
...
export const get_sessionless_launch_url_for_external_tool_courses = { type: "GET_SESSIONLESS_LAUNCH_URL_FOR_EXTERNAL_TOOL_COURSES", method: "get", key: 'get_sessionless_launch_url_for_external_tool_courses'};
...
export const get_sessionless_launch_url_for_external_tool_accounts = { type: "GET_SESSIONLESS_LAUNCH_URL_FOR_EXTERNAL_TOOL_ACCOUNTS", method: "get", key: 'get_sessionless_launch_url_for_external_tool_accounts'};
...
export const get_single_external_tool_courses = { type: "GET_SINGLE_EXTERNAL_TOOL_COURSES", method: "get", key: 'get_single_external_tool_courses'};
...
export const get_single_external_tool_accounts = { type: "GET_SINGLE_EXTERNAL_TOOL_ACCOUNTS", method: "get", key: 'get_single_external_tool_accounts'};
...
export const create_external_tool_courses = { type: "CREATE_EXTERNAL_TOOL_COURSES", method: "post", key: 'create_external_tool_courses'};
...
export const create_external_tool_accounts = { type: "CREATE_EXTERNAL_TOOL_ACCOUNTS", method: "post", key: 'create_external_tool_accounts'};
...
export const edit_external_tool_courses = { type: "EDIT_EXTERNAL_TOOL_COURSES", method: "put", key: 'edit_external_tool_courses'};
...
export const edit_external_tool_accounts = { type: "EDIT_EXTERNAL_TOOL_ACCOUNTS", method: "put", key: 'edit_external_tool_accounts'};
...
export const delete_external_tool_courses = { type: "DELETE_EXTERNAL_TOOL_COURSES", method: "delete", key: 'delete_external_tool_courses'};
...
export const delete_external_tool_accounts = { type: "DELETE_EXTERNAL_TOOL_ACCOUNTS", method: "delete", key: 'delete_external_tool_accounts'};