...
export const get_all_peer_reviews_courses_peer_reviews = { type: "GET_ALL_PEER_REVIEWS_COURSES_PEER_REVIEWS", method: "get"};
...
export const get_all_peer_reviews_sections_peer_reviews = { type: "GET_ALL_PEER_REVIEWS_SECTIONS_PEER_REVIEWS", method: "get"};
...
export const get_all_peer_reviews_courses_submissions = { type: "GET_ALL_PEER_REVIEWS_COURSES_SUBMISSIONS", method: "get"};
...
export const get_all_peer_reviews_sections_submissions = { type: "GET_ALL_PEER_REVIEWS_SECTIONS_SUBMISSIONS", method: "get"};
...
export const peer_reviews_create_peer_review_courses = { type: "PEER_REVIEWS_CREATE_PEER_REVIEW_COURSES", method: "post"};
...
export const peer_reviews_create_peer_review_sections = { type: "PEER_REVIEWS_CREATE_PEER_REVIEW_SECTIONS", method: "post"};
...
// }
// return canvasRequest(peer_reviews_create_peer_review_courses, {course_id, assignment_id, submission_id}, query);
export const peer_reviews_create_peer_review_courses = { type: "PEER_REVIEWS_CREATE_PEER_REVIEW_COURSES", method: "delete"};
...
// }
// return canvasRequest(peer_reviews_create_peer_review_sections, {section_id, assignment_id, submission_id}, query);
export const peer_reviews_create_peer_review_sections = { type: "PEER_REVIEWS_CREATE_PEER_REVIEW_SECTIONS", method: "delete"};