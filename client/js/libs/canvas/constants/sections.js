...
export const list_course_sections = { type: "LIST_COURSE_SECTIONS", method: "get"};
...
export const create_course_section = { type: "CREATE_COURSE_SECTION", method: "post"};
...
export const cross_list_section = { type: "CROSS_LIST_SECTION", method: "post"};
...
export const de_cross_list_section = { type: "DE_CROSS_LIST_SECTION", method: "delete"};
...
export const edit_section = { type: "EDIT_SECTION", method: "put"};
...
export const get_section_information_courses = { type: "GET_SECTION_INFORMATION_COURSES", method: "get"};
...
export const get_section_information_sections = { type: "GET_SECTION_INFORMATION_SECTIONS", method: "get"};
...
export const delete_section = { type: "DELETE_SECTION", method: "delete"};