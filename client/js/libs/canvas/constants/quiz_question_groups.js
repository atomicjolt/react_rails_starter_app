...
export const get_single_quiz_group = { type: "GET_SINGLE_QUIZ_GROUP", method: "get"};
...
export const create_question_group = { type: "CREATE_QUESTION_GROUP", method: "post"};
...
export const update_question_group = { type: "UPDATE_QUESTION_GROUP", method: "put"};
...
export const delete_question_group = { type: "DELETE_QUESTION_GROUP", method: "delete"};
...
export const reorder_question_groups = { type: "REORDER_QUESTION_GROUPS", method: "post"};