...
export const create_live_assessment_results = { type: "CREATE_LIVE_ASSESSMENT_RESULTS", method: "post"};
...
export const list_live_assessment_results = { type: "LIST_LIVE_ASSESSMENT_RESULTS", method: "get"};
...
export const create_or_find_live_assessment = { type: "CREATE_OR_FIND_LIVE_ASSESSMENT", method: "post"};
...
export const list_live_assessments = { type: "LIST_LIVE_ASSESSMENTS", method: "get"};