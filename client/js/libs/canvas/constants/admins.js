...
export const make_account_admin = { type: "MAKE_ACCOUNT_ADMIN", method: "post"};
...
export const remove_account_admin = { type: "REMOVE_ACCOUNT_ADMIN", method: "delete"};
...
export const list_account_admins = { type: "LIST_ACCOUNT_ADMINS", method: "get"};