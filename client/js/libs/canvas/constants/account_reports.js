...
export const list_available_reports = { type: "LIST_AVAILABLE_REPORTS", method: "get"};
...
export const start_report = { type: "START_REPORT", method: "post"};
...
export const index_of_reports = { type: "INDEX_OF_REPORTS", method: "get"};
...
export const status_of_report = { type: "STATUS_OF_REPORT", method: "get"};
...
export const delete_report = { type: "DELETE_REPORT", method: "delete"};