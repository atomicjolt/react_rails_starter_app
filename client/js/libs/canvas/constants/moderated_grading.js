...
export const list_students_selected_for_moderation = { type: "LIST_STUDENTS_SELECTED_FOR_MODERATION", method: "get", key: "list_students_selected_for_moderationlist_students_selected_for_moderation_{course_id}_{assignment_id}", required: ["course_id","assignment_id"] };
...
export const select_students_for_moderation = { type: "SELECT_STUDENTS_FOR_MODERATION", method: "post", key: "select_students_for_moderationselect_students_for_moderation_{course_id}_{assignment_id}", required: ["course_id","assignment_id"] };
...
export const show_provisional_grade_status_for_student = { type: "SHOW_PROVISIONAL_GRADE_STATUS_FOR_STUDENT", method: "get", key: "show_provisional_grade_status_for_studentshow_provisional_grade_status_for_student_{course_id}_{assignment_id}", required: ["course_id","assignment_id"] };
...
export const select_provisional_grade = { type: "SELECT_PROVISIONAL_GRADE", method: "put", key: "select_provisional_gradeselect_provisional_grade_{course_id}_{assignment_id}_{provisional_grade_id}", required: ["course_id","assignment_id","provisional_grade_id"] };
...
export const copy_provisional_grade = { type: "COPY_PROVISIONAL_GRADE", method: "post", key: "copy_provisional_gradecopy_provisional_grade_{course_id}_{assignment_id}_{provisional_grade_id}", required: ["course_id","assignment_id","provisional_grade_id"] };
...
export const publish_provisional_grades_for_assignment = { type: "PUBLISH_PROVISIONAL_GRADES_FOR_ASSIGNMENT", method: "post", key: "publish_provisional_grades_for_assignmentpublish_provisional_grades_for_assignment_{course_id}_{assignment_id}", required: ["course_id","assignment_id"] };