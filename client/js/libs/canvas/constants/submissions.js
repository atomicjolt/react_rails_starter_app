...
export const submit_assignment_courses = { type: "SUBMIT_ASSIGNMENT_COURSES", method: "post"};
...
export const submit_assignment_sections = { type: "SUBMIT_ASSIGNMENT_SECTIONS", method: "post"};
...
export const list_assignment_submissions_courses = { type: "LIST_ASSIGNMENT_SUBMISSIONS_COURSES", method: "get"};
...
export const list_assignment_submissions_sections = { type: "LIST_ASSIGNMENT_SUBMISSIONS_SECTIONS", method: "get"};
...
export const list_submissions_for_multiple_assignments_courses = { type: "LIST_SUBMISSIONS_FOR_MULTIPLE_ASSIGNMENTS_COURSES", method: "get"};
...
export const list_submissions_for_multiple_assignments_sections = { type: "LIST_SUBMISSIONS_FOR_MULTIPLE_ASSIGNMENTS_SECTIONS", method: "get"};
...
export const get_single_submission_courses = { type: "GET_SINGLE_SUBMISSION_COURSES", method: "get"};
...
export const get_single_submission_sections = { type: "GET_SINGLE_SUBMISSION_SECTIONS", method: "get"};
...
export const upload_file_courses = { type: "UPLOAD_FILE_COURSES", method: "post"};
...
export const upload_file_sections = { type: "UPLOAD_FILE_SECTIONS", method: "post"};
...
export const grade_or_comment_on_submission_courses = { type: "GRADE_OR_COMMENT_ON_SUBMISSION_COURSES", method: "put"};
...
export const grade_or_comment_on_submission_sections = { type: "GRADE_OR_COMMENT_ON_SUBMISSION_SECTIONS", method: "put"};
...
export const list_gradeable_students = { type: "LIST_GRADEABLE_STUDENTS", method: "get"};
...
export const grade_or_comment_on_multiple_submissions_courses_submissions = { type: "GRADE_OR_COMMENT_ON_MULTIPLE_SUBMISSIONS_COURSES_SUBMISSIONS", method: "post"};
...
export const grade_or_comment_on_multiple_submissions_sections_submissions = { type: "GRADE_OR_COMMENT_ON_MULTIPLE_SUBMISSIONS_SECTIONS_SUBMISSIONS", method: "post"};
...
export const grade_or_comment_on_multiple_submissions_sections_assignments = { type: "GRADE_OR_COMMENT_ON_MULTIPLE_SUBMISSIONS_SECTIONS_ASSIGNMENTS", method: "post"};
...
export const mark_submission_as_read_courses = { type: "MARK_SUBMISSION_AS_READ_COURSES", method: "put"};
...
export const mark_submission_as_read_sections = { type: "MARK_SUBMISSION_AS_READ_SECTIONS", method: "put"};
...
export const mark_submission_as_unread_courses = { type: "MARK_SUBMISSION_AS_UNREAD_COURSES", method: "delete"};
...
export const mark_submission_as_unread_sections = { type: "MARK_SUBMISSION_AS_UNREAD_SECTIONS", method: "delete"};