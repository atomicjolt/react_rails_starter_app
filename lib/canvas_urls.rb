  ...
  def self.urls
    {
      ...
      UPLOAD_FILE => { uri: ->(folder_id:) { "folders/#{folder_id}/files" }, method: "POST" },
      ...
      QUERY_BY_COURSE => { uri: ->(course_id:) { "audit/grade_change/courses/#{course_id}" }, method: "GET" },
      ...
      UPLOAD_FILE => { uri: ->(group_id:) { "groups/#{group_id}/files" }, method: "POST" },
      PREVIEW_PROCESSED_HTML => { uri: ->(group_id:) { "groups/#{group_id}/preview_html" }, method: "POST" },
      ...
      CREATE_PEER_REVIEW_COURSES => { uri: ->(course_id:, assignment_id:, submission_id:) { "courses/#{course_id}/assignments/#{assignment_id}/submissions/#{submission_id}/peer_reviews" }, method: "DELETE" },
      CREATE_PEER_REVIEW_SECTIONS => { uri: ->(section_id:, assignment_id:, submission_id:) { "sections/#{section_id}/assignments/#{assignment_id}/submissions/#{submission_id}/peer_reviews" }, method: "DELETE" },
      ...
      SET_EXTENSIONS_FOR_STUDENT_QUIZ_SUBMISSIONS => { uri: ->(course_id:, quiz_id:) { "courses/#{course_id}/quizzes/#{quiz_id}/extensions" }, method: "POST" },
      ...
      UPLOAD_FILE => { uri: ->(course_id:, quiz_id:) { "courses/#{course_id}/quizzes/#{quiz_id}/submissions/self/files" }, method: "POST" },
      ...
      UPLOAD_FILE => { uri: ->(course_id:, assignment_id:, user_id:) { "courses/#{course_id}/assignments/#{assignment_id}/submissions/#{user_id}/comments/files" }, method: "POST" },
      ...
      UPLOAD_FILE => { uri: ->(user_id:) { "users/#{user_id}/files" }, method: "POST" },
