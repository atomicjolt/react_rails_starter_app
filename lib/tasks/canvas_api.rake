namespace :canvas do
  ...
  class CanvasApiBuilder
    ...
    def self.build
      ...
      directory["apis"].each do |api|
        ...
        resource['apis'].each do |resource_api|
          resource_api["operations"].each do |operation|
            ...
            canvas_urls_rb << Render.new("./canvas_api/rb_url.erb", api, resource, resource_api, operation, parameters, nil, nil).render
            canvas_urls_js << Render.new("./canvas_api/js_url.erb", api, resource, resource_api, operation, parameters, nil, nil).render
      ...
      Render.new("./canvas_api/js_urls.erb", nil, nil, nil, nil, nil, canvas_urls_js, nil).save("#{Rails.root}/../atomic-lti/lib/canvas/urls.js")

      Render.new("./canvas_api/graphql_types.erb", nil, nil, nil, nil, nil, models.compact, nil).save("#{Rails.root}/../atomic-lti/lib/canvas/graphql_types.js")
      Render.new("./canvas_api/graphql_queries.erb", nil, nil, nil, nil, nil, queries, nil).save("#{Rails.root}/../atomic-lti/lib/canvas/graphql_queries.js")
      Render.new("./canvas_api/graphql_mutations.erb", nil, nil, nil, nil, nil, mutations, nil).save("#{Rails.root}/../atomic-lti/lib/canvas/graphql_mutations.js")
    end
